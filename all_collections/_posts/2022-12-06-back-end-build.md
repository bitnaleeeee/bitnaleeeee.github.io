...
![aws1파일](/build/assets/img/posts/back-end-build-img01.png)
EC2 Instances 페이지로 이동 후 Launch Instances 을 클릭하여 EC2 Instance의 이름을 작성하고 Ubuntu를 선택 하였다.

<br>

![aws2파일](/build/assets/img/posts/back-end-build-img02.png)
`Instance Type` 은 t2.micro를 선택하고 새키페어생성을 눌러 아래와 같이 선택 후 원하는 키 페어 이름을 입력한다.

<br>

![aws3파일](/build/assets/img/posts/back-end-build-img03.png)
네트워크 편집 버튼을 누른 후 위와 같이 설정해 주고 퍼블릭IP는 활성화를 선택해준다.

![aws4파일](/build/assets/img/posts/back-end-build-img04.png)
...
![aws5파일](/build/assets/img/posts/back-end-build-img05.png)
